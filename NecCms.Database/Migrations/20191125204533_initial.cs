    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IcerikTipleri", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefon = table.Column<string>(maxLength: 15, nullable: false),
                    Cinsiyet = table.Column<short>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IcerikTipDegerleri", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IcerikTipDegerleri_IcerikTipleri_IcerikTipiId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", "admin@crm.com", null, "admin@crm.com", 1, (short)0, new DateTime(2019, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "05456286324" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IcerikTipDegerleri_IcerikTipiId",
